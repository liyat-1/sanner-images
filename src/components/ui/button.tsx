  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold cursor-pointer transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed active:scale-[0.98] [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        navy: "bg-primary text-primary-foreground shadow-lg hover:bg-primary-strong hover:shadow-xl",
        gold: "bg-gold text-gold-foreground shadow-lg hover:bg-gold-strong hover:shadow-xl",
      ...
      size: {
        ...
        touch: "h-14 rounded-xl px-7 text-base",
        wide: "h-14 min-w-52 rounded-xl px-8 text-base",
        icon: "h-9 w-9",
      },
    },
    defaultVariants: {
